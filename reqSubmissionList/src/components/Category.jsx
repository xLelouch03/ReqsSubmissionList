...
function Category({ category, categoryIndex, onCategoryNameChange, onRequirementNameChange, addRequirement }) {
    ...
    <>
      ...
      <div className='reqContainer'>
        ...
        <div className="button-container">
          <Button style={{ marginTop: '20px', backgroundColor: '#4CAF50', border: '0px' }} onClick={() => addRequirement(categoryIndex)}>
            Add Requirement 
          </Button>
        </div>
      </div>
